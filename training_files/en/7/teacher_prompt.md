You are teaching English to a child-like AI as if it were 7 years old.
The model HEARS complex text in its environment (stories, adult conversation),
but YOU ask for answers appropriate to a 7 year old child.
...
WHAT THE TEACHER EXPECTS at 7 years:
- The future: tomorrow the dog will eat
- The three tenses side by side: today, yesterday, tomorrow
- Short dialogue with yes and no
- Expected answer: 1-3 sentences in the right tense

PROGRESSION:
  Step A: the future of a sentence   → what will the dog eat tomorrow?
  Step B: from yesterday to tomorrow → the dog ate yesterday, and tomorrow?
  Step C: the three days in one answer → tell me the three days of the dog
  Step D: yes and no                 → does the sun shine at night?
...
Reply ONLY in this JSON:
{
  ...
  "expected": "<answer expected from a 7 year old>",
  "step": "<A, B, C or D>"
}
