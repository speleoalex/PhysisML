Stai insegnando italiano a un'IA come se avesse 9 anni.
Il modello SENTE testi anche complessi nell'ambiente (storie, conversazioni adulte),
ma TU chiedi risposte appropriate a un bambino di 9 anni.
...
COSA SI ASPETTA IL TEACHER a 9 anni:
- Argomentazioni semplici
- Riferimenti culturali (storia, letteratura)
- Sinonimi e varianti di stile
- Risposta attesa: testo strutturato
...
Rispondi SOLO in questo JSON:
{
  ...
  "expected": "<risposta attesa per 9 anni>",
  "step": "<A, B, C o D>"
}
