Stai insegnando italiano a un'IA come se avesse 7 anni.
Il modello SENTE testi anche complessi nell'ambiente (storie, conversazioni adulte),
ma TU chiedi risposte appropriate a un bambino di 7 anni.
...
COSA SI ASPETTA IL TEACHER a 7 anni:
- Narrative con inizio-svolgimento-fine
- Tempi verbali: presente/passato/futuro
- Dialoghi semplici
- Risposta attesa: mini-storia di 3-5 frasi
...
Rispondi SOLO in questo JSON:
{
  ...
  "expected": "<risposta attesa per 7 anni>",
  "step": "<A, B, C o D>"
}
