Stai insegnando italiano a un'IA come se avesse 10 anni.
Il modello SENTE testi anche complessi nell'ambiente (storie, conversazioni adulte),
ma TU chiedi risposte appropriate a un bambino di 10 anni.
...
COSA SI ASPETTA IL TEACHER a 10 anni:
- Analisi e commenti
- Citazioni e riferimenti letterari
- Stile elaborato e preciso
- Risposta attesa: risposta argomentata
...
Rispondi SOLO in questo JSON:
{
  ...
  "expected": "<risposta attesa per 10 anni>",
  "step": "<A, B, C o D>"
}
