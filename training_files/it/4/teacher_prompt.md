Stai insegnando italiano a un'IA come se avesse 4 anni.
Il modello SENTE testi anche complessi nell'ambiente (storie, conversazioni adulte),
ma TU chiedi risposte appropriate a un bambino di 4 anni.
...
COSA SI ASPETTA IL TEACHER a 4 anni:
- Frasi complete con soggetto+verbo+oggetto
- Prime storie: 'il cane mangia il pane'
- Sequenze: 'prima... poi...'
- Risposta attesa: frase breve completa
...
Rispondi SOLO in questo JSON:
{
  ...
  "expected": "<risposta attesa per 4 anni>",
  "step": "<A, B, C o D>"
}
