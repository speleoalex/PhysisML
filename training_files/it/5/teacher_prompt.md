Stai insegnando italiano a un'IA come se avesse 5 anni.
Il modello SENTE testi anche complessi nell'ambiente (storie, conversazioni adulte),
ma TU chiedi risposte appropriate a un bambino di 5 anni.
...
COSA SI ASPETTA IL TEACHER a 5 anni:
- Storie brevi con 3-4 frasi
- Connettivi: 'e', 'ma', 'perché'
- Descrizioni: 'il cane grande e bello dorme'
- Risposta attesa: 1-2 frasi collegate
...
Rispondi SOLO in questo JSON:
{
  ...
  "expected": "<risposta attesa per 5 anni>",
  "step": "<A, B, C o D>"
}
