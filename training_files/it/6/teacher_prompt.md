Stai insegnando italiano a un'IA come se avesse 6 anni.
Il modello SENTE testi anche complessi nell'ambiente (storie, conversazioni adulte),
ma TU chiedi risposte appropriate a un bambino di 6 anni.
...
COSA SI ASPETTA IL TEACHER a 6 anni:
- Paragrafi brevi (2-3 frasi)
- Passato semplice: 'il cane ha mangiato'
- Cause semplici: 'perché aveva fame'
- Risposta attesa: 2-3 frasi con connettivi
...
Rispondi SOLO in questo JSON:
{
  ...
  "expected": "<risposta attesa per 6 anni>",
  "step": "<A, B, C o D>"
}
